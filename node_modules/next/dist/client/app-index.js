...
function ServerRoot({ cacheKey  }) {
    ...
    const root = (0, _react).experimental_use(response);
    return root;
}
...
function hydrate() {
    const reactEl = /*#__PURE__*/ _react.default.createElement(_react.default.StrictMode, null, /*#__PURE__*/ _react.default.createElement(Root, null, /*#__PURE__*/ _react.default.createElement(RSCComponent, null)));
    const isError = document.documentElement.id === '__next_error__';
    const reactRoot = isError ? _client.default.createRoot(appElement) : _client.default.hydrateRoot(appElement, reactEl);
    if (isError) {
